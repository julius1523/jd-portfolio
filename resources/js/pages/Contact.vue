            ...
            <v-card flat tile color="surface-light">
                <v-container class="d-flex flex-column ga-5 my-5 my-md-13" :max-width="450">
                    ...
                    <v-form @submit.prevent="submit" :disabled="loading">
                        <v-row gap="13" class="mt-3 animate">
                            <v-col cols="12">
                                <v-text-field v-model="name" color="primary" variant="solo" flat label="Name"
                                    rounded="lg" density="comfortable" clearable :error-messages="errors.name"
                                    autocomplete="off"></v-text-field>
                            </v-col>
                            <v-col cols="12">
                                <v-text-field v-model="email" color="primary" variant="solo" flat label="Email"
                                    rounded="lg" density="comfortable" clearable :error-messages="errors.email"
                                    autocomplete="off"></v-text-field>
                            </v-col>
                            <v-col cols="12">
                                <v-textarea v-model="message" color="primary" auto-grow variant="solo" flat
                                    label="Message" rounded="lg" density="comfortable" clearable
