                ...
                <v-col cols="12" md="7">
                    ...
                    <div class="d-flex flex-row justify-center justify-md-start ga-3 my-4 my-md-10">
                        <div v-for="item in data.socials" class="reveal-item">
                            <v-icon-btn icon variant="tonal" size="x-large" color="primary" class="translate-y-hover"
                                :href="item.linkUrl" target="_blank">
                                <v-icon size="33">
                ...
                <v-row gap="5" class="mt-3 reveal-item">
                    ...
                    <v-col cols="12">
                        <v-btn type="submit" color="primary" rounded="pill" variant="flat" size="large" height="56"
                            block text="Send Email" :loading="loading" :disabled="!ready || !valid || loading" />
                    </v-col>
                </v-row>
            </v-form>
        </v-container>
