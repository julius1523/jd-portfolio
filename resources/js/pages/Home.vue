    ...
    <section id="home" ref="homeSection">
        <v-container>
            <v-row align="center" class="mt-0 mt-md-15">
                <v-col order="1" order-md="0" cols="12" md="7">
                    <div class="d-flex flex-column ga-2 ga-md-4">
                        <div
                            class="text-headline-medium text-lg-headline-large font-weight-semibold text-center text-md-start reveal-item">
                            Hello, I'm
                            <span class="text-no-wrap">Julius</span>
                        </div>
                        <div
                            class="text-display-small text-lg-display-medium font-weight-bold text-primary text-center text-md-start reveal-item">
                            <span ref="el">
                            </span>
                        </div>
                        <div
                            class="text-medium-emphasis text-center text-md-start w-100 w-sm-75 w-md-100 mx-auto reveal-item">
...
useScrollReveal(homeSection, { selector: '.reveal-item', stagger: 0.15, y: 40 });
</script>